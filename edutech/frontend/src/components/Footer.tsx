            ...
            <div className="flex gap-3">
              {[Github, Twitter, Instagram, Youtube].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="p-2 rounded-lg bg-theme-card-hover text-theme-text-muted hover:text-violet-400 hover:bg-violet-500/10 transition-all"
                >
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.label}>
                  <Link to={item.to} className="text-theme-text-muted hover:text-violet-400 text-sm transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Help Center', 'Contact Us', 'FAQ', 'Privacy Policy', 'Terms of Service'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-theme-text-muted hover:text-violet-400 text-sm transition-colors">
                    {item}
                  </a>
                </li>
              ))}
